...
final class CraftingSkillRegistry {
    ...
    static final class SkillReward {
    ...
    static {
        ...
        rules.add(new SkillRuleSet(
                SkillType.ARCHITECT,
                new HashMap<>(),
                keywordRule("furniture", 1, 20, "deco", "smooth", "bolt", "wool", "petals", "wall", "cauldron", "wood", "brick", "roof", "beam", "half", "stairs")
        ));
        rules.add(new SkillRuleSet(
                SkillType.ALCHEMY,
                new HashMap<>(),
                keywordRule("potion", 1, 20, "bomb")
        ));
        rules.add(new SkillRuleSet(
                SkillType.FARMING,
                new HashMap<>(),
    ...
    @Nullable
    static SkillReward findByRecipeId(@Nullable String recipeId) {
        return findMatch(recipeId);
    }

    @Nullable
    static SkillReward findByItemId(@Nullable String itemId) {
    ...
    static double getMaterialMultiplier(@Nullable String rawId) {
        if (rawId == null || rawId.isEmpty()) {
            return 1.0;
        }
    ...
    static double getBenchTierMultiplier(int tierLevel) {
