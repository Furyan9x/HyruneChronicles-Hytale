...
import dev.hytalemodding.origins.gamemode.StarterKitProvider;
...
public class GameModeSelectionPage extends InteractiveCustomUIPage<GameModeSelectionPage.SelectionData> {
    ...
    public void build(@Nonnull Ref<EntityStore> ref,
        ...
        GameModeDataComponent component = store.getComponent(ref, Origins.getGameModeDataComponentType());
        if (component == null) {
            component = new GameModeDataComponent();
            store.putComponent(ref, Origins.getGameModeDataComponentType(), component);
        }
