...
import dev.hytalemodding.hyrune.dialogue.*;
...
import dev.hytalemodding.hyrune.slayer.SlayerTaskState;
import dev.hytalemodding.hyrune.slayer.SlayerTurnInResult;
import dev.hytalemodding.hyrune.ui.GameModeSelectionPage;
import dev.hytalemodding.hyrune.ui.SlayerVendorPage;

import java.util.logging.Level;

import static dev.hytalemodding.hyrune.dialogue.SimpleDialogue.choice;

/**
 * Registers NPC dialogues and dialogue-bound actions for Hyrune.
 */
public class HyruneDialogue {
                ...
                .add("greeting", "Hello, adventurer! Welcome to -server-. ",
                        ...
                        choice("I want to choose my game mode")
                                .showIf((playerRef, playerEntityRef, store) -> {
                                    ...
                                    GameModeDataComponent component = store.getComponent(playerEntityRef, Hyrune.getGameModeDataComponentType());
