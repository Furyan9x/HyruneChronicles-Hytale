...
public class FishingInteraction extends SimpleInstantInteraction {
    ...
    private static final String MODEL_ASSET_ID = "HyruneFishingBobber";
    private static final String CAST_SOUND_ID = "SFX_Hyrune_Fishing_Rod_Cast";
    private static final String REEL_SOUND_ID = "SFX_Hyrune_Fishing_Rod_Reel";
    ...
    private static void handleReel(PlayerRef playerRef,
        ...
        FishingBobberComponent bobber = commandBuffer.getComponent(bobberRef, Hyrune.getFishingBobberComponentType());
        updateRodMetadata(inventory, null);
    ...
    public static UUID spawnBobber(Store<EntityStore> store,
                                   Vector3i target,
                                   PlayerRef playerRef,
        ...
        holder.addComponent(Hyrune.getFishingBobberComponentType(), bobber);

        store.addEntity(holder, AddReason.SPAWN);
        return uuid;
    }

    public static void updateRodMetadata(Inventory inventory, UUID bobberId) {
        if (inventory == null) {
            return;
        }
